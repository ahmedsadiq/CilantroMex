...
//    Button back;
    ...
    protected void onCreate(Bundle savedInstanceState) {
		...
		if (extras != null)
			url = AndroidUtil.MENU_ZOES;
		else
			url = AndroidUtil.TERMS_OF_USE;
//        url = getString(R.string.terms_url);
        		//"http://app.relevantmobile.com/terms_of_use";
...
//        });
        ...
        webview.loadUrl(url);
        progressdilog = ProgressDialog.show(TermsOfUseActivity.this, "", getString(R.string.loading), true);
